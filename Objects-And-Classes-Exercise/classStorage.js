...
let storages = new Storage(50);
storages.addProduct(productOne);
storages.addProduct(productTwo);
storages.addProduct(productThree);
storages.getProducts();
console.log(storages.capacity);
console.log(storages.totalCost);
